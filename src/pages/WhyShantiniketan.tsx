    ...
    <main className="pt-32 pb-24 container mx-auto px-4 max-w-7xl min-h-[60vh] overflow-hidden">
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-heading font-extrabold text-brand-darkblue mb-8 leading-tight">
            Why <span className="bg-brand-darkblue text-brand-cream px-2 rounded-lg whitespace-nowrap">Shantiniketan</span> School?
          </h1>
            ...
            {METHODS.map((method, idx) => {
              ...
              return (
                <motion.div 
                  ...
                  className="flex items-center gap-3 bg-white p-4 rounded-xl shadow-sm border border-zinc-100 hover:shadow-md transition-shadow"
                >
                  <div className="w-10 h-10 rounded-lg bg-brand-darkblue/5 text-brand-darkblue flex items-center justify-center shrink-0">
                    <Icon size={20} />
                  </div>
        ...
        >
           <div className="relative rounded-[40px] overflow-hidden shadow-2xl">
             ...
             <div className="absolute inset-0 bg-gradient-to-t from-brand-darkblue/60 to-transparent" />
           </div>
           
           {/* Floating abstract decorative box */}
           <motion.div 
            animate={{ y: [0, -10, 0] }} transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute -bottom-10 -left-10 bg-white p-8 rounded-3xl shadow-xl max-w-xs border border-zinc-100 hidden md:block"
           >
             <div className="text-brand-cream mb-4">
               <Trophy size={40} />
             </div>
             <h4 className="text-xl font-bold text-brand-darkblue mb-2">Meaningful Learning</h4>
             <p className="text-sm text-brand-slate">Hands-on approach providing lasting educational experiences.</p>
           </motion.div>
        </motion.div>
