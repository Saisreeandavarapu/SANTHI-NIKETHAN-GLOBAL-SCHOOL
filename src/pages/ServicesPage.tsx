...
export default function ServicesPage() {
  return (
    <>
      <section className="relative min-h-[90vh] md:min-h-screen flex items-center pt-16  pb-10 overflow-hidden bg-brand-primary">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md mx-auto lg:mx-0 lg:w-full"
            >
              <div className="relative w-full aspect-[4/5] rounded-[2.5rem] shadow-2xl shadow-brand-accent/20 group">
                {/* Image Container */}
                <div className="absolute inset-0 rounded-[2.5rem] overflow-hidden border border-white/10">
                ...
                <motion.div
                  ...
                  className="absolute bottom-6 lg:-left-6 xl:-left-12 z-20 bg-brand-secondary/90 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl flex items-center gap-3 hover:-translate-y-1.5 transition-transform duration-300"
                >
                  ...
                  <div>
                    <h4 className="text-white font-black text-base">Top Rated</h4>
